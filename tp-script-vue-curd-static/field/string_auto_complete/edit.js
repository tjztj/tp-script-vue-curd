define([],function(){
    return {
        ...
        template:`<div class="field-box">
                    <div class="l">
                        <a-auto-complete v-model:value="val" :placeholder="field.placeholder||'请填写'+field.title" :disabled="field.readOnly" :options="autoCompleteOptions" :default-open="field.defaultOpen" @search="onAutoCompleteSearch"/>
                    </div>
                    <div class="r">
