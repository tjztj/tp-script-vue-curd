                                ...
                                <div class="ant-upload-list-item ant-upload-list-item-done ant-upload-list-item-list-type-text">
                                    <div class="ant-upload-list-item-info" style="display: inline-block">
                                        <span>
                                            ...
                                            <a target="_blank" style="display: inline-block" rel="noopener noreferrer" class="ant-upload-list-item-name ant-upload-list-item-name-icon-count-1" title="查看/下载" :href="vo">{{getUrlTitle(vo)}}</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
