    ...
    return {
        ...
        template: `<div>
                    <div style="display: inline-block;padding: 2px;border:1px solid #dcdfe6;border-radius: 2px;vertical-align: middle">
                        <div :style="{'background-color':info[field.name],height:'calc(1.5715em - 6px)',width:'calc(1.5715em - 6px)','border-radius':'2px'}"></div>
                    </div>
                     <span style="color: #8c8c8c;padding-left: 8px;vertical-align: middle;font-size: 12px">HEX颜色代码：<span v-if="value">{{value}}</span><span v-else style="color: #bfbfbf">未选择颜色</span></span>
