...
abstract class FieldStepBase
{
    ...
    public function __construct(array $fields)
    {
        ...
        $this->step = FieldStep::make(
            static::name(),
            StepCheck::make(
                fn (BaseModel $info, BaseModel $parentInfo = null, ModelField $field = null) => $this->stepCheckFunc($info, $parentInfo, $field),
    ...
    protected function stepCheckFunc(BaseModel $info, BaseModel $parentInfo = null, ModelField $field = null): bool
    {
        $funcs = $this->beforeCheck();
        if (empty($info->id)) {
            if (!isset($funcs[''])) {
