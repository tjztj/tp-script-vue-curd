...
<head>
    ...
    <link rel="stylesheet" href="/tp-script-vue-curd-static.php?ant-design-vue/antd.min.css?2.2.6" media="all">
    <link rel="stylesheet" href="/tp-script-vue-curd-static.php?css/vue.css?v={$vueCurdDebug?time():$vueCurdVersion}" media="all">
    <script src="/tp-script-vue-curd-static.php?vue3/vue.global.prod.js?3.2.4" charset="utf-8"></script>
    ...
    <script src="/tp-script-vue-curd-static.php?ant-design-vue/antd.min.js?2.2.6" charset="utf-8"></script>
    <script>
        window.VUE_CURD={
            GUID: "{$guid}",
